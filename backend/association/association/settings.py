...
ALLOWED_HOSTS = ['kaffoassociation.pythonanywhere.com', '127.0.0.1', 'localhost']
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PAGINATION_CLASS': 'association.rest_framework_utils.custom_pagination.CustomPageNumberPagination'
}
